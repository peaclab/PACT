...
#python CRICoolingTool.py "${lcf_file}" "${config_file}" "${modelParams_file}" "--gridSteadyFile" "${grid_dir}${grid_file}"
time -ao ${log}MyToolRun_${chiplabel}_${grid_rows}x${grid_cols}_HybridWick.log python CRICoolingTool.py "${lcf_file}" "${config_file}" "${modelParams_file}" "--gridSteadyFile" "${grid_dir}${grid_file}"
