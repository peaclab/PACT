...
import VisualPACT transient_data_file --layer ptrace_layers[0]

for i in range(1,len(ptrace_layers)):
    importlib.reload(VisualPACT transient_data_file --layer ptrace_layers[i])
