...
#grid_dir=chiplabel+'/8x8/'+coolant
...
bg = 100
#bg = 20
os.system('python3 CRICoolingTool.py Tests_withHotSpot/'+lcf_file+'_UniformPD_'+str(bg)+'Wcm2.csv Tests_withHotSpot/default2Phase.config  Tests_withHotSpot/modelParams2Phase.config --gridSteadyFile ' + grid_dir+'twophaseRunUniformPD_'+str(bg)+'.csv')
