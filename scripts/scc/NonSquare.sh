...
time -ao ${log}${run_name}_${chiplabel}_${grid_rows}x${grid_cols}_NonSquare.log python CRICoolingTool.py "${lcf_file}" "${config_file}" "${modelParams_file}" "--gridSteadyFile" "${grid_dir}${grid_file}"
