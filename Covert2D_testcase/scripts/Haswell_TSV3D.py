...
#folder = '../M3D_covert/'
lcf = folder + 'lcf_files/Haswell_tileslcf_alllayers_TSV3D.csv'
modelParams = folder+'modelParams_files/Haswell_TSV3D_modelParams.config'
runName = 'MyToolRun'
...
for grids in grids_ll:
    ...
    for htc in htc_ll:
        configFile = folder+'config_files/Haswell_TSV3D.config'
