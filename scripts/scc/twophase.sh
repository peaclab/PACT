...
grid_dir=${chiplabel}/${grid_rows}x${grid_cols}/${coolant}/
grid_file=${run_name}_${pdenType}_${pdenVal}Wcm2.csv
scp_file=${scp_dir}${run_name}_${pdenType}_${pdenVal}Wcm2.grid.steady
...
#time -ao ${log}${run_name}_${chiplabel}_${pdenType}_${grid_rows}x${grid_cols}_Si_only.log python CRICoolingTool.py "${lcf_file}" "${config_file}" "${modelParams_file}" "--gridSteadyFile" "${grid_dir}${grid_file}"
time -ao ${log}MyToolRunTwoPhase_${chiplabel}_${grid_rows}x${grid_cols}_twophase.log python CRICoolingTool.py "${lcf_file}" "${config_file}" "${modelParams_file}" "--gridSteadyFile" "${grid_dir}${grid_file}"
#time python CRICoolingTool.py "${lcf_file}" "${config_file}" "${modelParams_file}" "--gridSteadyFile" "${grid_dir}${grid_file}"
scp ${results}${grid_dir}${grid_file} prachis@128.197.127.15:${scp_file}
#time python dummy_scc.py
