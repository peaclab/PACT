                ...
                #print (label,cfile)
                    if(self.label_mode_dict[label]=='single'):
                        if(label=='Si'):
                            ...
                            LibTwoPhase.defineGridProperties(grid_length,grid_width,thickness,self.config._sections['TwoPhaseVC'],RCIout)
                            ...
                            LibCu.defineGridProperties(grid_length,grid_width,thickness,self.config._sections['Cu'],RCIout)
                        ...
                        if(label=='HybridWick'):
                            ...
                            LibHybridWick.defineGridPropertiesMatrix(label,grid_length,grid_width,thickness,properties,RCIout)
                        ...
                        if(label=='Si'):
                            ...
                            LibSi.defineGridPropertiesMatrix(grid_length,grid_width,thickness,properties,RCIout)
